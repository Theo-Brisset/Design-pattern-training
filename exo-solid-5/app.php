...
print_r($userArrayRepository->getUsers());
print_r($userJSONRepository->getUsers());
...
print_r($userArrayRepository->getUser('mathieu.nebra@exemple.com'));
print_r($userJSONRepository->getUser('laurene.castor@exemple.com'));